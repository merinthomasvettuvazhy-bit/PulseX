...
function processCommand(command) {
  ...
  if (cmd.includes("police") ||
      cmd.includes("find police stations") ||
      cmd.includes("police station") ||
      cmd.includes("search police stations") ||
      cmd.includes("police stations") ||
      cmd.includes("find police") ||
      cmd.includes("search police") ||
      cmd.includes("search police station") ||
      cmd.includes("find police station") && 
      !cmd.includes("call")) {
    findPolice();
    speakText("Searching for police stations. Please scroll down to get Police Stations");
    return;
  }
  ...
  if (cmd.includes("share universal SOS") ||
     cmd.includes("send url") ||
     cmd.includes("send link") ||
     cmd.includes("send universal link") ||
     cmd.includes("universal") ||
     cmd.includes("url") ||
     cmd.includes("link") ||
     cmd.includes("share universal link") ||
     cmd.includes("share link") ||
     cmd.includes("share url") ||
     cmd.includes("url link") ||
     cmd.includes("send url link") ||
     cmd.includes("share url link")) {
    shareUniversalSOS();
